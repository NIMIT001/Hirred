...
const Joblist = () => {
  ...
  if (!isLoaded) {
    return <BarLoader className="mb-4" width={"100%"} color="#36d7b7" />; //This is a loading bar
  }
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSearch} className="h-14 flex flex-row w-full gap-2 items-center mb-3">
        <Input typr = "text" placeholder ="Search Jobs by Title.." name ="search-query" className="h-full flex-1 px-4 text-md"/>
